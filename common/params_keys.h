...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DisableDisengageOnBrake", {PERSISTENT, BOOL, "1"}},
    ...
    {"TeslaRadarFilteringEnabled", {PERSISTENT, BOOL, "0"}},
    {"TeslaLeadSelectionEnabled", {PERSISTENT, BOOL, "0"}},
    {"TeslaSetSpeedOwnershipEnabled", {PERSISTENT, BOOL, "0"}},
